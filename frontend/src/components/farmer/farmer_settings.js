        ...
        <main style={{ ...styles.card, ...styles.main }}>
          {activeTab === "notifications" && (
            <>
              ...
              <ToggleRow icon={<Eye />} title="Booking Updates" desc="Get notified about equipment rental status" />
          ...
          {activeTab === "danger" && (
             <div style={{...styles.sectionCard, borderLeft: '4px solid #dc2626'}}>
                ...
                <button
                  ...
                  onClick={() => addToast("Account deletion requires secure backend confirmation.", "error")}
                >
                  Delete My Account
                </button>
              </div>
